...
import { AfterLoad, BaseEntity, Entity, ManyToOne, OneToMany, PrimaryGeneratedColumn } from 'typeorm';
...
export class Match extends BaseEntity implements IMatch {
  ...
  @OneToMany(() => PlayerStat, playerStats => playerStats.match, { eager: true })
  stats: PlayerStat[];
